...
const SystemIntegrationTab = () => {
  const [selectedIntegration, setSelectedIntegration] = useState('wing_mc');

  const integrations = [
    {
      id: 'wing_mc',
      name: 'Wing MC Core Banking',
      description: 'Primary banking system integration for account validation and transaction processing',
      status: 'connected',
      lastSync: '2025-01-13 08:45:00',
      endpoint: 'https://api.wingmc.internal/v2',
      health: 98.5,
      responseTime: 145,
      dailyRequests: 15420,
      errorRate: 0.02,
      features: ['Account Validation', 'Balance Inquiry', 'Transaction Processing', 'Branch Data']
    },
    {
      id: 'active_directory',
              ...
              <div className="bg-card border border-border rounded-lg">
                <div className="p-4 border-b border-border">
                  <div className="flex items-center justify-between">
                    ...
                    <Button
                      ...
                      onClick={() => console.log('View full logs')}
                    >
                      View Logs
                    </Button>
                  </div>
                ...
                <div className="p-4">
                  <div className="space-y-3">
                    {[
                      { time: '08:45:00', type: 'success', message: 'Successful sync completed' },
                      { time: '08:30:00', type: 'info', message: 'Connection health check passed' },
                      { time: '08:15:00', type: 'warning', message: 'Elevated response time detected' },
                      { time: '08:00:00', type: 'success', message: 'Authentication renewed' }
                    ]?.map((log, index) => (
                      <div key={index} className="flex items-center space-x-3 text-sm">
                        ...
                        <Icon name={
                          ...
                          log?.type === 'error' ? 'XCircle' : 'Info'
                        } size={14} className={
                          log?.type === 'success' ? 'text-success' :
                          log?.type === 'warning' ? 'text-warning' :
                          log?.type === 'error' ? 'text-error' : 'text-accent'
                        } />
